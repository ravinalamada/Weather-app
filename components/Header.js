...
function Header() {
  const { handleClick, fetchNearestLoc } = useContext(Context)

  return (
    <header className='header'>
      <button className='header__btn--search' onClick={handleClick}>
        Search for places
      </button>
      <button className='header__btn' onClick={fetchNearestLoc}>
        <svg
          stroke='#E7E7EB'
          fill='#E7E7EB'
          strokeWidth='0'
